...
export default component$(() => {
  return (
    <div class="bg-white dark:bg-primary-500 max-w-7xl mx-auto">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-2 place-items-center h-screen">
        ...
        <div class="relative mx-2">
          ...
          <div class="bg-gray-100 dark:bg-primary-800 absolute bottom-5 top-5 left-5 w-full h-full rounded-md shadow-md"></div>
